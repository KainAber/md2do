...
def app():
    ...
    while True:
        ...
        while has_function_call(response_message):
            ...
            function_result = execute_function_call(functions_module, function_name, function_args, todo_md.splitlines())
            ...
            messages = add_function_call_to_messages(messages, response_message, function_name, function_result)
